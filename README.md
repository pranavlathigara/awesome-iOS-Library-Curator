...
- **[RACSnippets](https://github.com/lzyy/RAC-Snippets)**: Various RAC Snippets. This project is really really good. It has a whole bunch of different cases in which you might use RAC. These cases are listed below
	- Use 'then' and 'take' 
    - Simple MVVM
